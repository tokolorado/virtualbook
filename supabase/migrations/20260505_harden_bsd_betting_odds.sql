-- Require displayable real BSD odds at the database boundary.
-- App-level validation is useful for UX, but these SECURITY DEFINER functions
-- are the final guard before a bet is written.
